...
class FeatureEngineer:
    def __init__(self):
        ...
        # Define holidays for North Rhine-Westphalia, Germany
        self.holidays = [
        ...
        # Define school vacation periods for North Rhine-Westphalia, Germany
        self.school_vacations = [
            ('2013-02-18', '2013-03-01'), ('2013-03-25', '2013-04-05'),
            ('2013-05-21', '2013-06-01'), ('2013-07-15', '2013-08-24'),
            ('2013-10-14', '2013-10-26'), ('2013-12-23', '2014-01-04'),
            ('2014-02-17', '2014-02-28'), ('2014-03-24', '2014-04-04'),
            ('2014-05-20', '2014-05-31'), ('2014-07-14', '2014-08-23'),
            ('2014-10-13', '2014-10-25'), ('2014-12-22', '2015-01-03'),
            ('2015-02-16', '2015-02-27'), ('2015-03-23', '2015-04-03'),
            ('2015-05-19', '2015-05-30'), ('2015-07-13', '2015-08-22'),
            ('2015-10-12', '2015-10-24'), ('2015-12-21', '2016-01-02')
        ]
    ...
    def create_external_features(self, df):
        """Add external features like holidays, school vacations, and economic indicators"""
        # Convert holidays to datetime
        holidays_dt = pd.to_datetime(self.holidays)
        
        # Create holiday indicator
        df['IsHoliday'] = df['Date'].isin(holidays_dt).astype(int)
        
        # Create school vacation indicator
        df['IsSchoolVacation'] = 0
        for start, end in self.school_vacations:
            start_date = pd.to_datetime(start)
            end_date = pd.to_datetime(end)
            mask = (df['Date'] >= start_date) & (df['Date'] <= end_date)
            df.loc[mask, 'IsSchoolVacation'] = 1
            
        # Create economic indicators (simplified for this example)
        # In a real scenario, these would come from external data sources
        df['UnemploymentRate'] = 7.5  # Simplified constant value
        df['ConsumerConfidence'] = 95.0  # Simplified constant value
        
        # Create interaction features with external factors
        df['Holiday_Weekend'] = df['IsHoliday'] * df['IsWeekend']
        df['SchoolVacation_Weekend'] = df['IsSchoolVacation'] * df['IsWeekend']
        df['Holiday_Promo'] = df['IsHoliday'] * df['Promo']
        df['SchoolVacation_Promo'] = df['IsSchoolVacation'] * df['Promo']
...
class RossmannPipeline:
    ...
    def run_pipeline(self, train_path, store_path):
        ...
        df = self.feature_engineer.create_external_features(df)
