...
def train_and_evaluate(X, y):
    ...
    for name, model in models.items():
        ...
        if name == 'LightGBM':
            ...
            # Initialize eval_result dictionary
            eval_result = {}
            ...
            preds = model_lgb.predict(X_val_scaled, num_iteration=model_lgb.best_iteration)
        elif name == 'XGBoost':
    ...
    if best_model_name == 'LightGBM':
        ...
        final_preds = model_lgb.predict(X_val_scaled, num_iteration=model_lgb.best_iteration)
    ...
    # Feature importance
    if best_model_name == 'LightGBM' and 'model_lgb' in locals():
