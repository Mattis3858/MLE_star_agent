...
def engineer_features(df):
    ...
    df['state_holiday_store_type'] = df['StateHoliday'].astype(str) + '_' + df['StoreType'].astype(str)
    df['school_holiday_store_type'] = df['SchoolHoliday'].astype(str) + '_' + df['StoreType'].astype(str)
...
def prepare_features(df):
    ...
    categorical_features = ['Store', 'DayOfWeek', 'StateHoliday', 'StoreType', 'Assortment', 'PromoInterval', 
                           'state_holiday_store_type', 'school_holiday_store_type']
